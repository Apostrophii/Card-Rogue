module.exports = function() {
    ...
    test_battle_card1 = function(socket, session, io, game) {
        ...
        orc1 = {name: 'Bob', race: 'orc', weapon: weapon1, armor: armor1, health: 10, speed: 2, str: 4, dex: 1, kno: 5, wis: 4, pattern: 'random'};
        orc2 = {name: 'Bill', race: 'orc', weapon: weapon1, armor: armor1, health: 8, speed: 3, str: 5, dex: 2, kno: 1, wis: 1, pattern: 'random'};
        orc3 = {name: 'Brains', race: 'orc', weapon: weapon1, armor: armor1, health: 10, speed: 4, str: 2, dex: 3, kno: 3, wis: 1, pattern: 'random'};
